...
public class ShopFilter implements Filter {
	...
	if (debug) log("ShopFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("ShopFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("ShopFilter:doFilter()");
	...
	if (filterConfig == null) return ("ShopFilter()");
