                            ...
                            <div class="container">
                                <div class="row justify-content-start">
                                    <div class="col-lg-7">
                                        ...
                                        <a href="actioncustomer?action=getListFood" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Sản Phẩm</a>
                            ...
                            <div class="container">
                                <div class="row justify-content-start">
                                    <div class="col-lg-7">
                                        ...
                                        <a href="actioncustomer?action=getListFood" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">View</a>
                                        <a href="contact.jsp" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">Liên Hệ</a>
                                    </div>
                                </div>
                            </div>
